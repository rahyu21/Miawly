...
@section('content')
                            ...
                            <form action="/brg_keluar/store" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" readonly value="{{'NBK-'.$kd}}" placeholder="No Barang Keluar..." name="no_brg_keluar" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div id="detail_barang">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" id="jml_brg_keluar" name="jml_brg_keluar" class="form-control" placeholder="Jumlah Barang ..." required>
    ...
    <script src="text/javascript">
        $(document).ready(function(){
            $("#jml_brg_keluar").change(function(){
                var jml_brg_keluar = $("#jml_brg_keluar")
                var harga = $("#harga")
